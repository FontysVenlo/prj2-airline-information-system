...
The demo-implementation uses the second approach (DataRecords). DataRecords are classes that represent immutable data carrier objects that are available in all layers of your application. Have a look at the CustomerData class and the Customer class in the demo application.
